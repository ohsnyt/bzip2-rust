...
pub fn compress_block(opts: &mut BzOpts, data: &[u8], bw: &mut BitWriter, block: &Block) {
    ...
    let result = huf_encode(opts, bw, &rle2_data, &freq_out, symbol_map, eob);
