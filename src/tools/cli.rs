...
fn help() {
   ...
   -k --keep           keep (don't delete) input files (ALWAYS KEEPS. NOT IMPLEMENTED)
   -f --force          overwrite existing output files (NOT IMPLEMENTED)
   ...
   -s --small          use less memory (at most 2500k) (NOT IMPLEMENTED)
